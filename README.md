...
- **Agent wrap** — `headroom wrap claude|codebuddy|codex|cursor|aider|copilot|opencode` in one command Cursor prints manual proxy settings to paste into the app
