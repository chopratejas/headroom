...
```json
{
  ...
  "parameters": {
    ...
    "query": "Optional targeted search query for a concrete gap. Use it when the kept summary cannot answer a specific follow-up. If omitted, returns all original items."
  }
}
```
