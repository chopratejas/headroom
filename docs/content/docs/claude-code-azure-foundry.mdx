...
```
Foundry mode: ANTHROPIC_FOUNDRY_BASE_URL=http://127.0.0.1:8787
  → upstream https://my-org-claude.services.ai.azure.com
```
...
`https://{ANTHROPIC_FOUNDRY_RESOURCE}.services.ai.azure.com` — with your auth
