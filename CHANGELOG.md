...
* **proxy:** suppress CancelledError noise on Ctrl+C shutdown; ensure reliable SIGINT handling in multi-worker mode ([#shutdown](https://github.com/chopratejas/headroom/pull/shutdown))
