...
* **litellm:** add the missing `async_post_call_success_hook` to `HeadroomCallback` so litellm's post-call success path no longer raises `AttributeError` ([#1114](https://github.com/headroomlabs-ai/headroom/issues/1114)).
